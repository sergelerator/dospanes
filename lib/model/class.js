...
function createBaseModelInstance(attributesPrototype, methodsPrototype){
...
function Model(modelName, modelDescription){
  var attributesPrototype, methodsPrototype, resourcePath, syncSources, syncTargets;
  ...
  if (!Model[modelName]){
    ...
    Model[modelName] = Object.create(baseModelClass, {
      ...
      baseInstance: _protected(createBaseModelInstance(attributesPrototype, methodsPrototype)),
